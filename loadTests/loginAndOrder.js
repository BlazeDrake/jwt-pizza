...
export function scenario_1() {
  ...
  group('Buy a pizza - https://pizza.cs329.click/', function () {
    response = http.get('https://pizza.cs329.click/', {
      headers: {
        ...
        'if-modified-since': 'Thu, 04 Sep 2025 21:10:59 GMT',
        prefer: 'safe',
        priority: 'u=0, i',
    ...
    response = http.post(
      ...
      '{"items":[{"menuId":1,"description":"Veggie","price":0.0038},{"menuId":3,"description":"Margarita","price":0.0042},{"menuId":2,"description":"Pepperoni","price":0.0042}],"storeId":"23","franchiseId":19}',
      {
        headers: {
          accept: '*/*',
          'accept-encoding': 'gzip, deflate, br, zstd',
